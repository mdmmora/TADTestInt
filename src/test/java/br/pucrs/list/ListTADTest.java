package br.pucrs.list.tests; 

import static org.junit.Assert.*;

import org.junit.*;

import br.pucrs.list.ListArray;
import br.pucrs.list.ListSimpleLinked;
import br.pucrs.list.ListTAD;
...
public class ListTADTest {
	...
	public final void testAddIntD0() {
		assertEquals("Inserção em posição inváida:", false, myList.add(1, "1"));
	}
